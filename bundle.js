...
var app = (function () {
	...
	var css_248z$2 = ".component[name=image-compare-slider].svelte-xyld2j{position:relative;max-height:var(--height);width:fit-content;user-select:none;touch-action:none}img.svelte-xyld2j{max-height:var(--height)}img.background-img.svelte-xyld2j{position:relative}.overlay.svelte-xyld2j{position:absolute;top:0;left:0;height:inherit;overflow:hidden;box-sizing:border-box;box-shadow:calc(var(--slideWidth)/2* 1px) 0px 0px var(--slideColor);border-right:solid;border-right-width:calc(var(--slideWidth)/2* 1px);border-right-color:var(--slideColor);opacity:var(--overlayOpacity)}.handle.svelte-xyld2j{position:absolute;height:calc(var(--handleSize)*1px);width:calc(var(--handleSize)*1px);border:solid;border-width:calc(var(--handleGirth)*1px);border-radius:3px;border-color:var(--handleColor);transform:rotate(-45deg);mask:radial-gradient(circle 10px at top right, #0000 100%,var(--handleColor)) top right,\r\n          radial-gradient(circle 10px at bottom left, #0000 98%, var(--handleColor)) bottom left;mask-size:50%;mask-repeat:no-repeat;opacity:var(--handleOpacity);cursor:grab}";
	...
	function create_else_block(ctx) {
		...
		return {
			c() {
				img_1 = element("img");
				attr(img_1, "class", "unique-img svelte-xyld2j");
	...
	function create_if_block$1(ctx) {
		...
		return {
			c() {
				...
				attr(div1, "class", "handle svelte-xyld2j");
	...
	function create_fragment$4(ctx) {
		...
		return {
			c() {
				...
				attr(div, "class", "component svelte-xyld2j");
