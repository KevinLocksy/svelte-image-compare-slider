var app = (function () {
	...
	*/
	...
	var css_248z$1 = "div[name=slideColor].svelte-2r1jot{height:8px;width:160px;background:linear-gradient(to right,hsl(0,100%,50%),hsl(60,100%,50%),hsl(120,100%,50%),hsl(180,100%,50%),hsl(240,100%,50%),hsl(300,100%,50%),hsl(360,100%,50%));border-radius:20px}";
	...
	function create_fragment(ctx) {
		...
		return {
			c() {
				...
				t2 = space();
				div0 = element("div");
				div0.innerHTML = `<p>Demonstration of a Svelte component to compare two images with a slider. Easy to use and possibility to custom it</p>`;
				t4 = space();
				main = element("main");
				div1 = element("div");
				...
				attr(header, "class", "svelte-1fkqcjo");
				attr(div0, "id", "standfirst");
				attr(div0, "class", "svelte-1fkqcjo");
				...
				attr(main, "class", "svelte-1fkqcjo");
				attr(footer, "class", "svelte-1fkqcjo");
				attr(div4, "id", "demo-image-compare-slider");
				attr(div4, "class", "svelte-1fkqcjo");
			},
			m(target, anchor) {
